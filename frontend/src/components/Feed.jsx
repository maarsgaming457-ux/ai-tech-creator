    ...
    <div className="w-full flex flex-col gap-4">
      ...
      {loading ? (
        <motion.div 
          ...
          className="flex flex-col items-center justify-center py-20 text-center gap-4 bg-white/5 border border-white/10 rounded-2xl"
        >
          <div className="w-12 h-12 rounded-full border border-[#00ff9f]/30 bg-[#00ff9f]/10 flex items-center justify-center">
            <Sparkles className="w-6 h-6 text-[#00ff9f] animate-pulse" />
          </div>
          <div>
